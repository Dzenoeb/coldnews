...
$dopParams = !empty($_POST['dop_params']) ? $_POST['dop_params'] : [];
...
$infoData = [
    ...
    'dop_params' => $dopParams,         // Дополнительные параметры
];
...
$subid = implode(':', [$gitsan, $subId2, $subId3, $subId4, $subId5]);

// ключ
$key = '5c80b29f9daef686648084259fa1a2501beca18f277804';
...
if (function_exists('curl_init') && $ch = curl_init()) {
    ...
    curl_setopt($ch, CURLOPT_POSTFIELDS, http_build_query($infoData));
